...
function Card({ className }) {
  ...
  return (
    <Slider {...settings}>
        ...
        >
          ...
          <div className="conteudo sm:text-center md:text-left md:w-[500px]">
            <p className="text-white mb-2">
              ...
              expedita? Nulla repellendus voluptates ipsa nobis alias sed
              dolorum quisquam deleniti maiores eos quia modi facere aspernatur,
              non fuga sapiente vitae.
            </p>
            <p className="text-white mb-2">
      ...
      <div className="relative overflow-hidden" key={2}>
        <div
          className={
            className
              ? className + " card w-full h-[80vh] lg:px-[20em] "
